...
image_url = "https://upload.wikimedia.org/wikipedia/commons/f/fc/Baegle_dwa.jpg"  # @param
downloaded_image_path = download_and_resize_image(image_url, 1280, 856, False)

module_handle = "https://tfhub.dev/google/faster_rcnn/openimages_v4/inception_resnet_v2/1"
cached_module = "/home/tungdt/python/src/object_detect_from_hub/cached_modules/6e850c920451d5243d1fb87a3242c087535b9183"
print('cp1')
with tf.Graph().as_default():
    detector = hub.Module(cached_module)
    print('cp2')
